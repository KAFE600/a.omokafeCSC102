...
#Step one
a1 = float(input("Emter your a1 :"))
a2 = float(input("Enter your a2 :"))
a3 = float(input("Enter your a3 :"))
...
#Step Four(root 3 is expressed as 1.732)
X1 =  (int(S) + int(T)) - 1/3*int(a1) 
X2 = -1/2*(int(S) + int(T)) - 1/3*int(a1) + 1/2*(1.732*(int(S) - int(T)))
X3 = -1/2*(int(S) + int(T)) - 1/3*int(a1) - 1/2*(1.732*(int(S) - int(T)))
